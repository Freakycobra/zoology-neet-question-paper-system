...
export const zoologySyllabus: SyllabusNode[] = [
  {
    id: '11-ch4', name: 'Animal Kingdom', classLevel: 11,
    unit: 'Unit 1: Diversity in Living World', chapter: 'Chapter 4',
    subtopics: [
  ...
  {
    id: '11-ch7', name: 'Structural Organisation in Animals', classLevel: 11,
    unit: 'Unit 2: Structural Organisation in Plants and Animals', chapter: 'Chapter 7',
    subtopics: [
  ...
  {
    id: '11-ch9', name: 'Biomolecules', classLevel: 11,
    unit: 'Unit 3: Cell: Structure and Function', chapter: 'Chapter 9',
    subtopics: [
  ...
  {
    id: '11-ch18', name: 'Body Fluids and Circulation', classLevel: 11,
    unit: 'Unit 5: Human Physiology', chapter: 'Chapter 18',
    subtopics: [
      'Blood: composition, plasma, formed elements',
      'Blood groups (ABO, Rh)', 'Coagulation of blood', 'Lymph (tissue fluid)',
  ...
  {
    id: '11-ch19', name: 'Excretory Products and Their Elimination', classLevel: 11,
    unit: 'Unit 5: Human Physiology', chapter: 'Chapter 19',
    subtopics: [
      ...
      'Regulation of kidney function: RAAS, ADH, ANF', 'Micturition',
      'Role of other organs in excretion',
      'Disorders: uremia, renal failure, renal calculi, glycosuria',
    ], neetWeightage: 3,
  },
  {
    id: '11-ch20', name: 'Locomotion and Movement', classLevel: 11,
    unit: 'Unit 5: Human Physiology', chapter: 'Chapter 20',
    subtopics: [
  ...
  {
    id: '11-ch21', name: 'Neural Control and Coordination', classLevel: 11,
    unit: 'Unit 5: Human Physiology', chapter: 'Chapter 21',
    subtopics: [
  ...
  {
    id: '11-ch22', name: 'Chemical Coordination and Integration', classLevel: 11,
    unit: 'Unit 5: Human Physiology', chapter: 'Chapter 22',
    subtopics: [
  ...
  {
    id: '12-ch2', name: 'Human Reproduction', classLevel: 12,
    unit: 'Unit 6: Reproduction', chapter: 'Chapter 2',
    subtopics: [
  ...
  {
    id: '12-ch3', name: 'Reproductive Health', classLevel: 12,
    unit: 'Unit 6: Reproduction', chapter: 'Chapter 3',
    subtopics: [
  ...
  {
    id: '12-ch6', name: 'Evolution', classLevel: 12,
    unit: 'Unit 7: Genetics and Evolution', chapter: 'Chapter 6',
    subtopics: [
  ...
  {
    id: '12-ch7', name: 'Human Health and Disease', classLevel: 12,
    unit: 'Unit 8: Biology in Human Welfare', chapter: 'Chapter 7',
    subtopics: [
  ...
  {
    id: '12-ch11', name: 'Biotechnology: Principles and Processes', classLevel: 12,
    unit: 'Unit 9: Biotechnology', chapter: 'Chapter 11',
    subtopics: [
  ...
  {
    id: '12-ch12', name: 'Biotechnology and Its Applications', classLevel: 12,
    unit: 'Unit 9: Biotechnology', chapter: 'Chapter 12',
    subtopics: [
...
export function getAllSubtopics(): { id: string; name: string; classLevel: 11 | 12; chapter: string }[] {
  ...
  zoologySyllabus.forEach((chapter) => {
    chapter.subtopics.forEach((sub, idx) => {
      subtopics.push({ id: `${chapter.id}-sub${idx}`, name: sub, classLevel: chapter.classLevel, chapter: chapter.name })
    })
  })
  return subtopics
}
